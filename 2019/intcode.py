...
class IntCodeComputer():
    ...
    def __init__(self, memory, input=None, noun=None, verb=None):
...
#        print(f"i:{i} opcodes:{opcodes} opcode:{opcode} outputs:{outputs}")
        ...
        # where the inputs and outputs are, not their values.
            ...
            self.write_mem(self.get_parameter(i, 1, force_immediate=True), self.input)
            return i+2
...
# Part 1:
print("Part 1:")
print(IntCodeComputer(input, 5).compute().output())
